...
var typeDir = {
    'Domain': 0, 'IP': 1, 'Cert': 2, 'Whois_Name': 3,
    'Whois_Phone': 4, 'Whois_Email': 5, 'IP_C': 6, 'ASN': 7
};
    ...
    xhr.onreadystatechange = function () {
        if (this.readyState === 4 && this.status === 200) {
            ...
            for (let i = 0; i < initLen; i++) {
                data['nodes'][i] = {};
                data['nodes'][i]['id'] = id[i];
                data['nodes'][i]['name'] = name[i];
                data['nodes'][i]['value'] = 1;
                data['nodes'][i]['category'] = typeDir[type[i]];
            }
        }
    }
}
...
function link_init() {
    ...
    xhr.onreadystatechange = function () {
        if (this.readyState === 4 && this.status === 200) {
            ...
            for (let i = 0; i < initLen; i++) {
                data['links'][i] = {};
                data['links'][i]['source'] = source[i];
                data['links'][i]['target'] = target[i];
            }
        }
    }
}
